...
dir_sshh="$dir_epik00/comandos/sshh.sh"
...
#Añadir aqui cada variable
{
    ...
    echo "alias act00='pkill act.sh; $dir_act00 & konsole -e '$dir_epik00sh' &  exit'"
